...
import { a as __toESM$1, r as __export, t as __commonJS } from "./chunk-XP5HYGXS-BwP9jRil.js";
...
var getAct = async () => {
	...
	if (typeof clonedReact.act == "function") reactAct = clonedReact.act;
		...
		let deprecatedTestUtils = await import("./test-utils-BvagCFj4.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
...
async function renderToCanvas({ storyContext, unboundStoryFn, showMain, showException, forceRemount }, canvasElement) {
	let { renderElement, unmountElement } = await import("./react-18-C71fZN3z.js").then((n) => n.t), Story = unboundStoryFn, content = storyContext.parameters.__isPortableStory ? import_react.createElement(Story, { ...storyContext }) : import_react.createElement(ErrorBoundary, {
		showMain,
		showException
...
var parameters = { renderer: "react" }, decorators = [(story, context) => {
	...
	let major = import_semver.default.major("19.2.3"), minor = import_semver.default.minor("19.2.3");
	...
	try {
		let { configure } = await import("./dist-IBvKFJMJ.js").then((n) => n.t), act = await getAct();
		configure({
...
//# sourceMappingURL=chunk-TENYCC3B-CgTnFY8E.js.map